...
maxNcores = 35  # this is for a server, standard PC has only 8
chunksize = 0.7 # it can be between 0.5 and 1

# Generic script for using GGIR in the ERC project
#=====================================================================================
# load GGIR or functions directly
# library(GGIR)
# # Load function files directly
...
if (study == "UKBiobank") {
  timewindow = "OO" # as the device comes from post, there is no "clinic influence"
  strategy = 1
  maxdur = 7
  datadir = datadir
  outputdir = outputdir
